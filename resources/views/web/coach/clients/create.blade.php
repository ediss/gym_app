                    ...
                    <form class="row g-3" action="{{ route('client.store') }}" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                <input v-model="client.name" name="name" type="text" placeholder="Name" class="form-control">
                            </div>
...
{{--                                    {{ message }}--}}
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                <input v-model="client.email" name="email" type="email" placeholder="E-mail address" class="form-control">
                            </div>
